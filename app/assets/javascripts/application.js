...
$(function() {
  $("#kevin").click(function() {
    $("#video").hide().html('<div class="flex-video"><iframe width="560" height="315" src="https://www.youtube.com/embed/Q33Xlbmo28k?autoplay=1" frameborder="0" allowfullscreen></iframe></div>').fadeIn(300);
  });
